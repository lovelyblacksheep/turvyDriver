...
import { DOMAIN } from '../Riders/Constant';
    ...
    async _sendMessageToRider(){
        ...
        fetch(DOMAIN+'api/rider/sendMessageToRider',{
            ...
            body: JSON.stringify({
                ...
                "receiver_id" : this.props.receiver.driver_id,
                "book_id" : this.props.receiver.book_id,
            ...
            >
                <View style={tipstyles.container}>
                 {
                    ...
                    Reply to {this.props.receiver.driver_name}
                </Text>
                    :
                <Text style={{backgroundColor:'#5ead97',color:'#FFF',paddingVertical:10,textAlign:'center',fontSize:19}}>
                    Send Message to {this.props.receiver.driver_name}
                </Text>
                } 
                <View style={tipstyles.subContainer}>
                        ...
                        <Row style={{height:moderateScale(40),marginHorizontal:moderateScale(10)}}>
                            <Col size={4}>
                                <Button mode="contained" color={'#5ead97'} onPress={() => this._sendMessageToRider()}>
                                    Send
                                </Button>
                            </Col>
